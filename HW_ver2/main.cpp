        ...
        try {
            ...
            // Группировка записей
                ...
                if (Data[1] == "by" && Data.size() == 4) {
                    if (Data[2] == "percentage")
                        GroupBySmth = DataBase->GroupByPercentage(Data[3] == "%");
            ...
            // Переименование БД
                ...
                fs::rename(fs::current_path().string() + "\\" + Data[1] + ".txt",
                           fs::current_path().string() + "\\" + Data[2] + ".txt");
            ...
            // Удаление БД
                ...
                fs::remove(fs::current_path().string() + "\\" + Data[1] + ".txt");
                if (DataBase != nullptr && Data[1] == DataBase->GetName()) {
                    DataBase->~DB();
                    delete DataBase;
                    DataBase = nullptr;
            ...
            //==========================================================================================================
                ...
                std::cout
                        ...
                        << "add [shoe|clothe] [name] [city] [capacity]\n"
                        << "erase [name]\n"
                        << "remove\n"
                        << "remove [name]\n"
                        << "get [name]\n"
                        ...
                        << "sort by Descending [Name|capacity]\n"
